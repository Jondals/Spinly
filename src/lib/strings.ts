import type { SpinlyLang } from './i18n';

// Solo texto fijo de la UI (inglés por defecto).
// Datos de usuario (nombres/descripciones/tags/username) NO se traducen.
type Entry = { en: string; es: string };

export const STRINGS = {
    header: {
        logoAlt: { en: 'Spinly logo', es: 'Logo de Spinly' },
        openMenu: { en: 'Open Wheel Manager', es: 'Abrir Wheel Manager' },
        closeMenu: { en: 'Close Wheel Manager', es: 'Cerrar Wheel Manager' },
    ...
    manager: {
        title: { en: 'Wheel Manager', es: 'Wheel Manager' },
        subtitle: { en: 'Set up your spin', es: 'Configura tu giro' },
        editor: { en: 'Wheel Editor', es: 'Wheel Editor' },
        presets: { en: 'Presets', es: 'Presets' },
        themes: { en: 'Themes', es: 'Themes' },
    },
    options: {
        title: { en: 'WHEEL EDITOR', es: 'WHEEL EDITOR' },
        ...
        changeImg: { en: 'Change background image', es: 'Cambiar imagen de fondo' },
    ...
    presets: {
        title: { en: 'SAVED PRESETS', es: 'PRESETS GUARDADOS' },
        ...
        mine: { en: 'My presets', es: 'Mis presets' },
        viewLabel: { en: 'Preset view', es: 'Vista de presets' },
        searchMine: { en: 'Search presets or tags...', es: 'Buscar presets o etiquetas...' },
        searchMineAria: { en: 'Search my presets', es: 'Buscar en mis presets' },
        searchCommunityAria: { en: 'Search community presets', es: 'Buscar presets en la comunidad' },
        newBtn: { en: 'New', es: 'Nuevo' },
        newAria: { en: 'Create new preset', es: 'Crear nuevo preset' },
        newTitle: { en: 'New preset from the current wheel', es: 'Nuevo preset desde la ruleta actual' },
        namePh: { en: 'Preset name', es: 'Nombre del preset' },
        tagsPh: { en: 'Tags (comma separated, optional)', es: 'Etiquetas (separadas por coma, opcional)' },
        create: { en: 'Save preset', es: 'Guardar preset' },
        untitled: { en: 'Untitled', es: 'Sin nombre' },
        editTitle: { en: 'Edit preset', es: 'Editar preset' },
        editCloudTitle: { en: 'Edit shared preset (cloud)', es: 'Editar preset compartido (nube)' },
        editHint: { en: 'Options and look are taken from the wheel: change them in Wheel Editor and come back here to save.', es: 'Las opciones y el aspecto se toman de la ruleta: cámbialos en Wheel Editor y vuelve aquí para guardar.' },
        updatedOk: { en: '"{name}" updated.', es: '"{name}" actualizado.' },
        empty: { en: 'No presets found.', es: 'No se encontraron presets.' },
        emptyCommunity: { en: 'No community presets yet.', es: 'No hay presets en la comunidad todavía.' },
        ...
        loadAria: { en: 'Load preset {name}', es: 'Cargar preset {name}' },
        use: { en: 'Use', es: 'Usar' },
        useAria: { en: 'Use preset {name}', es: 'Usar preset {name}' },
        sharedOk: { en: '"{name}" shared with the community.', es: '"{name}" compartido en la comunidad.' },
        usedOk: { en: '"{name}" loaded and saved to My presets.', es: '"{name}" cargado y guardado en Mis presets.' },
    },
    themes: {
        ...
        editHint: { en: 'Colors and images are taken from the wheel: change them in Wheel Editor and come back here to save.', es: 'Los colores e imágenes se toman de la ruleta: cámbialos en Wheel Editor y vuelve aquí para guardar.' },
        updatedOk: { en: '"{name}" updated.', es: '"{name}" actualizado.' },
    ...
    common: {
        ...
        communityDownloaded: { en: '{x} downloaded', es: '{x} descargados' },
        communityAvailable: { en: '{y} available', es: '{y} disponibles' },
        ...
        // Acciones de tarjeta unificadas (ItemActions): mismas en Themes y Presets
        ...
        whatPresets: { en: 'the presets', es: 'los presets' },
    ...
    // Mensajes de los servicios (Supabase/perfil/comunidad) y validaciones
    errors: {
        ...
        sharePreset: { en: 'Could not share the preset.', es: 'No se pudo compartir el preset.' },
        presetNoName: { en: 'The preset has no name.', es: 'El preset no tiene nombre.' },
        presetInvalid: { en: 'The preset contains invalid data.', es: 'El preset contiene datos no válidos.' },
...
// Sustituye {var} por su valor (sin HTML: React escapa en render).
...
// Mensaje en TODOS los idiomas. Errores/avisos que se guardan en estado usan esto
// (no un string ya resuelto): así se re-traducen si el usuario cambia de idioma
// mientras el mensaje sigue en pantalla. Se pinta con tm() de useTranslation.
...
// Igual que dictMessage, pero con variables que son a su vez mensajes localizados.
...
// Contenido semilla (DEFAULT_THEMES / DEFAULT_PRESETS): es texto fijo de la app,
// no dato de usuario, así que sí se localiza. Clave = id del tema/preset semilla.
