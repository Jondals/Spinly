...
export const STRINGS = {
    ...
    presets: {
        ...
        alreadyLoaded: { en: '"{name}" was already in My presets: loaded without downloading it again.', es: '"{name}" ya estaba en Mis preajustes: cargado sin volver a descargarlo.' },
    },
    themes: {
        ...
        applyDownloadedAria: { en: 'Apply theme {name}, already in My themes', es: 'Aplicar tema {name}, ya está en Mis temas' },
        ...
        alreadyApplied: { en: '"{name}" was already in My themes: applied without downloading it again.', es: '"{name}" ya estaba en Mis temas: aplicado sin volver a descargarlo.' },
    },
    common: {
        ...
        guestShareHint: { en: 'Sign in or create an account (profile icon) to share and to keep your themes and presets on any device.', es: 'Inicia sesión o crea una cuenta (icono de perfil) para compartir y tener tus temas y preajustes en cualquier dispositivo.' },
